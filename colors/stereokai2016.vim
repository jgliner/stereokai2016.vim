" ~ Stereokai2016 ~
" Based on Stereokai (https://github.com/gummesson/stereokai.vim)
" Derivative of Monokai-Refined (https://github.com/jaromero/vim-monokai-refined)
...
let g:colors_name = "stereokai2016"

" Editor highlighting
highlight Cursor ctermfg=234 ctermbg=NONE cterm=NONE guifg=#f8f8f2 guibg=#f92672 gui=NONE
highlight Visual ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=#444444 gui=NONE
...
highlight PmenuSel ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=#f92672 gui=NONE
...
highlight Folded ctermfg=95 ctermbg=NONE cterm=NONE guifg=#75715e guibg=#373736 gui=NONE
...
highlight ErrorMsg ctermfg=231 ctermbg=NONE cterm=NONE guifg=#f8f8f0 guibg=#f92672 gui=NONE
highlight WarningMsg ctermfg=231 ctermbg=NONE cterm=NONE guifg=#f8f8f0 guibg=#f92672 gui=NONE
...
highlight NonText ctermfg=59 ctermbg=NONE cterm=NONE guifg=#3b3a32 guibg=#212121 gui=NONE
...
highlight jsArrowFuncArgs ctermfg=208 ctermbg=NONE cterm=NONE guifg=#ff8700 guibg=NONE gui=NONE
highlight jsBraces ctermfg=231 ctermbg=NONE cterm=NONE guifg=#f8f8f2 guibg=NONE gui=NONE
highlight jsClassMethodDefinitions ctermfg=197 ctermbg=NONE cterm=NONE guifg=#ff005f guibg=NONE gui=NONE
highlight jsClassKeywords ctermfg=81 ctermbg=NONE cterm=NONE guifg=#5fd7ff guibg=NONE gui=NONE
highlight jsClassDefinition ctermfg=148 ctermbg=NONE cterm=NONE guifg=#afd700 guibg=NONE gui=NONE
highlight jsClassFuncName ctermfg=148 ctermbg=NONE cterm=NONE guifg=#afd700 guibg=NONE gui=NONE
highlight jsCvsTag ctermfg=197 ctermbg=NONE cterm=NONE guifg=#ff005f guibg=NONE gui=NONE
highlight jsFuncArgs ctermfg=208 ctermbg=NONE cterm=NONE guifg=#ff8700 guibg=NONE gui=NONE
highlight jsFuncName ctermfg=81 ctermbg=NONE cterm=NONE guifg=#5fd7ff guibg=NONE gui=NONE
highlight jsFunction ctermfg=148 ctermbg=NONE cterm=NONE guifg=#afd700 guibg=NONE gui=NONE
highlight jsGlobalObjects ctermfg=81 ctermbg=NONE cterm=NONE guifg=#5fd7ff guibg=NONE gui=NONE
highlight jsNoise ctermfg=197 ctermbg=NONE cterm=NONE guifg=#ff005f guibg=NONE gui=NONE
...
highlight jsValue ctermfg=141 ctermbg=NONE cterm=NONE guifg=#ae81ff guibg=NONE gui=NONE

" JSX highlighting (for React, overwrites XML)
highlight jsxRegion ctermfg=247 ctermbg=NONE cterm=NONE guifg=#9e9e9e guibg=NONE gui=italic
highlight xmlAttrib ctermfg=148 ctermbg=NONE cterm=NONE guifg=#afd700 guibg=NONE gui=NONE
highlight xmlEndTag ctermfg=197 ctermbg=NONE cterm=NONE guifg=#ff005f guibg=NONE gui=italic
highlight xmlTag ctermfg=197 ctermbg=NONE cterm=NONE guifg=#ff005f guibg=NONE gui=italic
highlight xmlTagName ctermfg=197 ctermbg=NONE cterm=NONE guifg=#ff005f guibg=NONE gui=italic
